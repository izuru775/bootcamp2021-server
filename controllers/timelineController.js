...
var connection = mysql.createConnection({
    host: process.env.RDS_HOSTNAME || 'bootcamp-rds.c1p3n24cw75f.ap-southeast-2.rds.amazonaws.com',
    user: process.env.RDS_USERNAME || 'admin',
    password: process.env.RDS_PASSWORD || 'launchpad',
    port: process.env.RDS_PORT || 3306,
    database: "bootcampuser"
});
